...
<head>
        ...
        <style type="text/css">
                .container2{
                        background-image:url("img/outstationCNFbg.jpg"); 
                        min-height: 650px;
                        padding: 60px;

                }
                .content-of-container2{
                        color: black;
        ...
        <div class="container2">
                <form action="requestToBook.php"
                        <div class="content-of-container2">
                                <h1 style="text-align: right;"> Estimated cost for your trip:<br> From <span style="color: red;"><?php echo "Mumbai"; ?></span> to <span style="color: red;"><?php echo "Pune";?></span><br>Will Cost Approx. <span style="color: rgb(55, 170, 17);">&#8377;<?php echo "1800";?></span></h1>
                                <br><button class="form-submit-btn" style="position: relative;left: 900px;">Request Out Station Cab</button>
                        </div>
                </form>
