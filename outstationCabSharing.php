...
<style type="text/css">
	...
	.main-container{
		background-image: url("img/outastaioncabs.jpg");
		...
		<div class="wrapper">
			...
			<div class="review-order-div-bg animate">
				<div class="review-order-div">
					<form action="quotePriceOutstation.php" method="POST">
					<center><h2>Lets get some details of your trip</h2></center>
					<hr>
					<div class="form-for-details">
						...
						<input list = "City" type="text" style="font-size: 150%;font-weight: bold;color: black;" class="form-inputs" placeholder="Destination">
						<label class="form-label">Travel Date:</label>
						<input type="text" style="font-size: 150%;font-weight: bold;color: black;" class="form-inputs" placeholder="02/12/2018">
						<label class="form-label">Car Type</label>
						<select style="width: 220px;color: black;font-size: 120%;font-weight: bold;">
						...
						<br>
						<label class="form-label" style="float: left">Passengers</label>
						<select style="width: 220px;color: black;font-size: 120%;font-weight: bold; float: left;position: relative;">
