<?php
   ...
   if(isset($_FILES['image']) && isset($_POST['submit'])){
      ...
      if(!mysqli_connect_error()) {
          ...
          $query = "INSERT INTO dashboard1 (`userid`,`title`,`author`,`genre`,`description`,`isbn`,`price`,`filename`) VALUES('$uname','$title','$author','$genre','$description','$isbn','$price','$file_name')";
