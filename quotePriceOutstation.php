...
<head>
        ...
        <div class="container2">
                <form action="requestToBook1.php"
                        <div class="content-of-container2">
                                <h1 style="text-align: right;"> Estimated cost for your shared cab:<br> From <span style="color: red;"><?php echo "Mumbai"; ?></span> to <span style="color: red;"><?php echo "Pune";?></span><br>Will Cost Approx. <span style="color: rgb(55, 170, 17);">&#8377;<?php echo "900";?></span></h1>
                                <br><button class="form-submit-btn" style="position: relative;left: 900px;">Request your Shared Cab</button>
                        </div>
                </form>
